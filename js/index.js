...
const users = [
  {
    ...
    favArt: [
      ...
      },
      {
        ...
        background:
          "https://i.scdn.co/image/5cf62c6c908c0a211c0a6eb5ea1878b17df5b9bb",
      },
      {
        name: "Achille Lauro",
        code: "0lI3rF4hi4op6UxqlLHPzv",
        image:
          "https://i.scdn.co/image/ab67616d0000b273d7d1c841048a5776dd5405c4",
        background:
          "https://i.scdn.co/image/b816d069fcf62c63e0336aae516e12c2dffcb650",
      },
    ],
  },
  {
    ...
    favArt: [
      {
        ...
        image:
          "https://i.scdn.co/image/ab67706f000000028d5942aae406a70180ba61d4",
        background:
          "https://i.scdn.co/image/3436d049d265e583180316158fbc130fe9583785",
      },
      {
        name: "Aerosmith",
        code: "7Ey4PD4MYsKc5I2dolUwbH",
        image:
          "https://i.scdn.co/image/ab67706f0000000214c46fb77a1d2b0fb8d3c218",
        background:
          "https://i.scdn.co/image/be3e460027e824a329f7363e49843b6847e8f31c",
      },
    ],
  },
  {
    ...
    favArt: [
      {
        ...
        image:
          "https://i.scdn.co/image/ab67706f000000027d0577e4b1b8e8ec9e82019a",
        background:
          "https://i.scdn.co/image/5e6706b6b643d88467b64a19b8ffe4218c6444f9",
      },
      {
        name: "Led Zeppelin",
        code: "36QJpDe2go2KgaRleHCDTp",
        image:
          "https://i.scdn.co/image/ab67706f0000000238c33894b80da5646d4a929f",
        background:
          "https://i.scdn.co/image/dec827bb3060c12c44054b78f9e49fd046a723cf",
      },
      {
        name: "Guns N' Roses",
        code: "3qm84nBOXUEQ2vnTfUTTFC",
        image:
          "https://i.scdn.co/image/ab67706f000000023dea752edffb0f7facbd4867",
        background:
          "https://i.scdn.co/image/6471a85d25ff05fad3f5f5b0a880a000298dd2c9",
      },
    ],
  },
  defaultUser,
...
const fetchCategoryName = async (cat_id) => {
  const res = await fetch(
    `https://api.spotify.com/v1/browse/categories/${cat_id}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
window.onload = function () {
  ...
  if (queryString.indexOf("#access_token") != -1) {
    ...
    queryString.indexOf("#access_token") == -1 &&
    ...
    .then((res) => {
      fetchPlaylists().then((res) => {
        ...
        localStorage.setItem(
          "playLists",
          JSON.stringify(currentUser.playlists)
        );
        renderPlaylist();
      });
    })
  ...
  if (window.location.href.indexOf("albums-fav") != -1) {
    ...
    fetchAlbum(code)
      ...
      .then((res) => spinner.classList.replace("d-flex", "d-none"))
      .then((res) => {
